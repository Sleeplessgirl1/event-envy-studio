      ...
      <div className="container-custom py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/60">
              <li><a href="/nosotros#faqs" className="hover:text-white transition-colors font-body">FAQs</a></li>
              <li><a href="/nosotros#politicas" className="hover:text-white transition-colors font-body">Políticas de servicio</a></li>
            </ul>
          </div>
        </div>
