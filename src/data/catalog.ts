...
export const categories: Category[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { id: "vaso-napa-azul", name: "Vaso Napa Azul", price: 4, colors: ["Azul"], image: "/catalog/napa azul.webp" },
      { id: "copa-arandano", name: "Copa Libia Rosa", price: 14, colors: ["Rosa"], image: "/catalog/libia arandano.jpg" },
      { id: "copa-verde-olivo", name: "Copa Libia Verde", price: 14, colors: ["Verde"], image: "/catalog/copa libia verde.webp" },
      { id: "copa-oro", name: "Copa Libia Oro", price: 14, colors: ["Oro"], image: "/catalog/libia oro.PNG" },
      { id: "copa-azul", name: "Copa Libia Azul", price: 14, colors: ["Azul"], image: "/catalog/libia azul.png" },
      { id: "copa-lila", name: "Copa Libia Lila", price: 14, colors: ["Lila"], image: "/catalog/lila libia.PNG" },
      { id: "copa-ocre", name: "Copa Libia Ocre", price: 14, colors: ["Ocre"], image: "/catalog/ocre.png" },
      { id: "copa-rayas-humo", name: "Copa Humo", price: 14, colors: ["Humo"], image: "/catalog/copa humo.png" },
      { id: "copa-rayas-oro", name: "Copa Rayas Oro", price: 14, colors: ["Oro"], image: "/catalog/copa oro tous.png" },
      { id: "copa-rayas-verde", name: "Copa Rayas Verde", price: 14, colors: ["Verde"], image: "/catalog/rayas verde.png" },
  ...
  {
    id: "utensilios-charolas",
    name: "Utensilios y Charolas",
    products: [],
  },
  {
    id: "decoracion",
